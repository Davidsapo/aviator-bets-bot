...
public interface TextingUtil {
    ...
    String WELCOME_MESSAGE = """
            Вас вітає ZEUS - бот яким за допомогою складних алгоритмів та стратегій аналізує широко відому гру Aviator та вираховує коефіцієнти на наступний політ літака.
                        
            Бот пропонує на вибір декілька стратегій на вибір які різняться між собою рівнем ризику та величиною можливого виграшу.
                        
            Бот використовую алгоритми які були написані за допомогою штучного інтелекту, що робить його унікальним і цій сфері.
